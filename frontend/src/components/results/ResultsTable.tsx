          ...
          <>
            <div>
              ...
              <ValueDisplay
                ...
                value={data.actual_requests_per_sec.toFixed(2)}
              />
              <ValueDisplay
                label="Average Response Time"
                value={(data.average_response_time / 1000000).toFixed(2) + "ms"}
              />
              <ValueDisplay
                label="Min Response Time"
                value={(data.min_response_time / 1000000).toFixed(2) + "ms"}
              />
              <ValueDisplay
                label="Max Response Time"
                value={(data.max_response_time / 1000000).toFixed(2) + "ms"}
              />
            </div>
          </>
        )}
